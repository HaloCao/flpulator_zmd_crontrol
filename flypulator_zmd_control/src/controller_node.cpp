#include "ros/ros.h"
#include "flypulator_zmd_control/controller_interface.h"  // performs all necessary includes
...
int main(int argc, char** argv)
{
  ...
  dynamic_reconfigure::Server<flypulator_zmd_control::zmd_parameterConfig> dr_srv;
  dynamic_reconfigure::Server<flypulator_zmd_control::zmd_parameterConfig>::CallbackType cb;
