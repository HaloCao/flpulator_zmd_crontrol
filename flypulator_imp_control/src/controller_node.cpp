#include "ros/ros.h"
#include "flypulator_imp_control/controller_interface.h"  // performs all necessary includes
...
int main(int argc, char** argv)
{
  ...
  dynamic_reconfigure::Server<flypulator_imp_control::imp_parameterConfig> dr_srv;
  dynamic_reconfigure::Server<flypulator_imp_control::imp_parameterConfig>::CallbackType cb;
